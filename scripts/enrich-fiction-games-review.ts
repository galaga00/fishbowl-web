...
const DESCRIPTION_OVERRIDES: Record<string, string> = {
  ...
  chess: "A strategy board game where kings, queens, bishops, knights, rooks, and pawns battle across a checkered board.",
  checkers: "A two-player board game where pieces move diagonally and jump opponents to capture them.",
  ...
  "C-3PO": "A fussy golden Star Wars protocol droid known for etiquette, translation, worrying, and arguing with R2-D2.",
  ...
  "Conan the Barbarian": "A sword-swinging fantasy warrior known for brute strength, survival, and pulp adventure.",
  "Hannibal Lecter": "A brilliant and terrifying fictional cannibal psychiatrist with polished manners and a chilling stare.",
  ...
  Hawkeye: "A Marvel archer known for a bow, trick arrows, sharp aim, and Avengers-level action.",
  ...
  "The Settlers of Catan": "A resource-trading board game about building roads, settlements, and cities on a hex-tile island.",
  Monopoly: "A real-estate board game about buying properties, charging rent, and trying not to go bankrupt.",
  "Big Brother": "The all-seeing ruler symbol from Nineteen Eighty-Four, tied to surveillance and propaganda.",
  "Two-Face": "A scarred Batman villain who flips a coin to decide his split-personality crimes.",
  Batgirl: "A Gotham superhero with a bat-themed suit, detective skills, gadgets, and ties to Batman.",
  ...
  "Count Dooku": "A refined Star Wars Sith lord and former Jedi, known for a curved lightsaber and aristocratic menace.",
  "Doctor Doom": "The armored ruler of Latveria, a Marvel villain with a metal mask, genius inventions, and sorcery.",
  ...
  "Kermit the Frog": "The green Muppet frog with a banjo, gentle leadership, and the song Rainbow Connection.",
  ...
  Robin: "Batman's acrobatic sidekick, known for a bright costume, detective work, and youthful crimefighting.",
  ...
  "Riddler": "A Batman villain obsessed with puzzles, question marks, elaborate traps, and proving his cleverness.",
  ...
  "Itachi Uchiha": "A calm Naruto shinobi with Sharingan eyes, black cloak, crows, and a tragic bond with Sasuke.",
  "Ichigo Kurosaki": "The Bleach hero with orange hair, a huge sword, and Soul Reaper powers.",
  "Slender Man": "A tall faceless internet horror figure in a black suit, often linked to forests and eerie photos.",
  ...
  "snakes and ladders": "A classic board game where players climb ladders, slide down snakes, and race to the final square.",
  ...
  Battleship: "A guessing board game where players call grid coordinates to find and sink hidden ships.",
  "Abraham Van Helsing": "The vampire-hunting professor from Dracula, known for garlic, stakes, and occult expertise.",
  "Boba Fett": "A helmeted Star Wars bounty hunter with Mandalorian armor, a jetpack, and a famously quiet menace.",
  "Ahsoka Tano": "An orange-and-white former Jedi with twin lightsabers, montrals, and a close history with Anakin.",
  Magneto: "An X-Men mutant master of magnetism, often shown with a helmet, cape, and militant mutant cause.",
  "Woody Woodpecker": "A red-headed cartoon bird known for a wild laugh, mischief, and rapid-fire pecking.",
  Risk: "A world-conquest board game about armies, territories, dice battles, and fragile alliances.",
  Senet: "An ancient Egyptian board game played on a grid of squares with racing pieces and symbolic rules.",
  "Captain Nemo": "Jules Verne's mysterious submarine captain who commands the Nautilus under the sea.",
  Borat: "Sacha Baron Cohen's fictional Kazakh reporter known for awkward interviews and outrageous misunderstandings.",
